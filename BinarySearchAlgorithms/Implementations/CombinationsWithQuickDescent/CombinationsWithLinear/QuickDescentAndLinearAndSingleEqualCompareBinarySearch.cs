...
public class QuickDescentAndLinearAndSingleEqualCompareBinarySearch : IBinarySearch
{
    private readonly int _optimizedSkipElementsCount;

    public QuickDescentAndLinearAndSingleEqualCompareBinarySearch()
    {
    ...
    public QuickDescentAndLinearAndSingleEqualCompareBinarySearch(int countElementsForLinearSearch)
    {
