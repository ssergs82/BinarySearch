...
public class LengthAdaptiveQuickDescentAndLinearAndCompareToMoreFirstBinarySearch2 : IBinarySearch
{
    public LengthAdaptiveQuickDescentAndLinearAndCompareToMoreFirstBinarySearch2()
    {
    }
    ...
    public int Find(int[] array, int key)
    {
        ...
        int low = high >> 1;
        int optimizedSkipElementsCount = low <= 256 ? 3 : low <= 384 ? 8 : low <= 448 ? 13 : 18;
