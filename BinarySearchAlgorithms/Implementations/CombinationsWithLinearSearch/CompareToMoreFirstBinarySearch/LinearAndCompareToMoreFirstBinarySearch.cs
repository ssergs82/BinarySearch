...
public class LinearAndCompareToMoreFirstBinarySearch : IBinarySearch
{
    private readonly int _optimizedSkipElementsCount;


    public LinearAndCompareToMoreFirstBinarySearch()
    {
    ...
    public LinearAndCompareToMoreFirstBinarySearch(int countElementsForLinearSearch)
    {
