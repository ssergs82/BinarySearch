...
public class LinearAndSingleEqualCompareBinarySearch : IBinarySearch
{
    private readonly int _optimizedSkipElementsCount;

    public LinearAndSingleEqualCompareBinarySearch()
    {
    ...
    public LinearAndSingleEqualCompareBinarySearch(int countElementsForLinearSearch)
    {
