...
public class LinearAndMonoboundBinarySearch : IBinarySearch
{
    private readonly int _countElementsForLinearSearch;

    public LinearAndMonoboundBinarySearch()
    {
        _countElementsForLinearSearch = 3;
    }

    public LinearAndMonoboundBinarySearch(int countElementsForLinearSearch)
    {
